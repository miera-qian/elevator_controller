...
class ElevatorAPIClient:
    ...
    def go_to_floor(self, elevator_id: int, floor: int, immediate: bool = False) -> bool:
        """电梯前往指定楼层"""
        print(f"[API] go_to_floor(elevator_id={elevator_id}, floor={floor}, immediate={immediate})")
        ...
        try:
            ...
            print(f"[API] go_to_floor response: {response}")
            return response
        except Exception as e:
            print(f"[API] Go to floor failed: {e}")
